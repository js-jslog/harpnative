import { getPozitionIds, getCovariantSet, getHarpStrata, PozitionIds } from 'harpstrata'
...
export const nudgeHarpStrataByPozition = (partialParams: PozitionOptionProps, direction: 'UP' | 'DOWN'): void => {
