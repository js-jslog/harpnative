...
type DisplayValueTuple = [ string, string ] | [string, undefined] | [undefined, undefined]
...
export const getDisplayValue = (props: HarpCellProps): DisplayValueTuple => {
  ...
  if ( degreeId === undefined || pitchId === undefined) return [undefined, undefined]

  const [note, ...modifiers] = 
    activeDisplayMode === DisplayModes.Degree ? degreeId.split('') : pitchId.split('')
